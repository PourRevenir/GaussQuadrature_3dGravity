function varargout = CuboidGravity_analytical2(model,area)
%CuboidGravity_analytical2 Calculate cuboid gravity anomalies and plot
%images. The cuboid gravity anomaly is calculated using the analytic solution
% 
%   value = CuboidGravity_analytical2(model)
%   value = CuboidGravity_analytical2(model,area)
%   
%   Input
