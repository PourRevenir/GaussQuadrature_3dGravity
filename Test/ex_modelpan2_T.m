...
[gxx, gxy, gyy, gzx, gyz, gzz] = prismgrad(x, y, z, rho, xpos, ypos, zpos);
...
subplot(331)
contourf(x,y,gxx*1000,12);  %单位换算E
xlabel('x(m)');   
ylabel('y(m)');  
colorbar;
% colormap(flip(seismic))
title('Txx(E)');   % title for the plot
axis image

subplot(332)
contourf(x,y,gxy*1000,12);  %单位换算E
xlabel('x(m)');   
ylabel('y(m)');  
colorbar;
% colormap(flip(seismic))
title('Txy(E)');   % title for the plot
axis image


subplot(333)
contourf(x,y,gzx*1000,12);  %单位换算E
xlabel('x(m)');   
ylabel('y(m)');  
colorbar;
% colormap(flip(seismic))
title('Txz(E)');   % title for the plot
axis image


subplot(335)
contourf(x,y,gyy*1000,12);  %单位换算E
xlabel('x(m)');   
ylabel('y(m)');  
colorbar;
% colormap(flip(seismic))
title('Tyy(E)');   % title for the plot
axis image

subplot(336)
contourf(x,y,gyz*1000,12);  %单位换算E
xlabel('x(m)');   
ylabel('y(m)');  
colorbar;
% colormap(flip(seismic))
title('Tyz(E)');   % title for the plot
axis image

subplot(339)
contourf(x,y,gzz*1000,12);  %单位换算E
xlabel('x(m)');   
ylabel('y(m)');  
colorbar;
% colormap(flip(seismic))
title('Tzz(E)');   % title for the plot
axis image
