...
%
%   values = CuboidGravity_GaussRadau(model)
%   values = CuboidGravity_GaussRadau(model,area)
%   values = CuboidGravity_GaussRadau(model,area,n)
%
%   Input
...
arguments
    ...
    [xi,yj,zk,W] = GaussRadauCoef3(model,n);
